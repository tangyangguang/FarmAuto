...
const Esp32At24cRecordStore::RegionConfig kFeederAt24cRegions[] = {
    ...
    makeRegion(FeederAt24cRecordType::Calibration, 9216, 256, 4),
    makeRegion(FeederAt24cRecordType::RecordIndex, 10240, 512, 4),
    makeRegion(FeederAt24cRecordType::SystemMeta, 12288, 128, 4),
};

const std::size_t kFeederAt24cRegionCount =
    sizeof(kFeederAt24cRegions) / sizeof(kFeederAt24cRegions[0]);

const uint32_t kFeederAt24cUsedBytes = 12800;
