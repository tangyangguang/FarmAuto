...
- `libs/21-encoded-dc-motor.md`：EncodedDcMotor 公共电机库方案。
- `libs/22-motor-current-guard.md`：MotorCurrentGuard 电流保护库方案。
- `libs/23-at24c-record-store.md`：At24cRecordStore 记录存储库方案。
