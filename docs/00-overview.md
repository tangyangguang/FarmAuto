...
- `apps/13-web-api-and-maintenance.md`：Web/API 公共约定。
...
- `apps/21-web-workflows.md`：Web 页面工作流和维护交互细化。
- `apps/22-record-event-schema.md`：应用长期记录事件 schema 草案。
- `apps/23-esp32base-web-integration.md`：Esp32Base Web、系统日志、App Config 与应用页面/API 边界。
- `apps/24-esp32-farmdoor-web-api.md`：Esp32FarmDoor 独立 Web/API 草案。
- `apps/25-esp32-farmfeeder-web-api.md`：Esp32FarmFeeder 独立 Web/API 草案。
